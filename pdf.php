...
// Prepare parameters for the QR code generation
        $params = array(
            "data" => "https://mfsmohgovom.ishiidreamtours.com/scan?id=" . $eid,
            "config" => array(
                "body" => "pointed-in",
                "eye" => "frame13",
                "eyeBall" => "ball14",
                ...
                "logo" => "https://mfsmohgovom.ishiidreamtours.com/logo2.png",
                "logoMode" => "default",
                    ...
                    <table>
                        <tbody>
                            <tr>
                                ...
                                <td data-label="Registration No" class="" ><?php echo ucwords($data['reg_type']) ?></td>
                                <th class="arabic"> :نوع الطلب</th>
                            </tr>
                            <tr>
                                <th>Application Number:</th>
                                <td data-label="Registration Type" class=""><?php echo ucwords($data['reg_no']) ?></td>
                                <th> :رقم الطلب</th>
                            </tr>
                        </tbody>
                    </table>
                ...
                <div class="info m-2 mt-3 mx-3 marl-zero">
                    <table>
                        ...
                        <tbody>
                            <tr>
                                <th>Name:</th>
                                <td class=""><?php echo strtoupper($data['name']) ?></td>
                                <th>:الاسم</th>
                            </tr>
                            <tr>
                                <th>Date of Birth:</th>
                                <td class=""><?php echo (new DateTime($data['dob']))->format('d-m-Y'); ?></td>
                                <th> :تاريخ الميلاد</th>
                            </tr>
                            <tr>
                                <th>Nationality:</th>
                                <td class=""><?php echo strtoupper($data['nationality']) ?></td>
                                <th> :الجنسية</th>
                            </tr>
                            <tr>
                                <th> Gender:</th>
                                <td class=""><?php echo strtoupper($data['sex']) ?></td>
                                <th> :الجنس</th>
                            </tr>
                            <tr>
                                <th>Passport No.:</th>
                                <td class=""><?php echo strtoupper($data['passport']) ?></td>
                                <th> :رقم جواز السفر</th>
                            </tr>
                            <tr>
                                <th>Civil No.:</th>
                                <td class=""><?php echo strtoupper($data['civilid']) ?></td>
                                <th> :الرقم المدني</th>
                            </tr>
                            <tr>
                                <th>Sponsor:</th>
                                <td class=""> <?php echo strtoupper($data['sponsor']) ?></td>
                                <th> :اسم الكفيل</th>
                            </tr>
                            <tr>
                                <th>Category:</th>
                                <td class=""><?php echo strtoupper($data['category']) ?></td>
                                <th> :الفئـة</th>
                            </tr>
                        </tbody>
                    </table>
                    ...
                    <table>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class=""><?php echo (new DateTime($data['validity']))->format('d-m-Y'); ?></td>
                                <th> :صلاحية الفحص الطبي</th>
                            </tr>
                            <tr>
                                <th>To:</th>
                                <td class=""><?php echo (new DateTime($data['toDate']))->format('d-m-Y'); ?></td>
                                <th> :إلى</th>
                            </tr>
                            <tr>
                                <th>Medical Center:</th>
                                <td><b><?php echo $data['medicalcentre'] ?></b></td>
                                <th> :المركز الطبي</th>
                            </tr>
                        </tbody>
                        </thead> 
